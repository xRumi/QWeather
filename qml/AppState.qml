...
Item {
    ...
    property var weatherCodeDecode: {
        ...
        51: { condition: "Light Drizzle",       color: 2,  icon: "assets/icons/cloud-rain.svg" },
        53: { condition: "Moderate Drizzle",    color: 2,  icon: "assets/icons/cloud-rain.svg" },
        55: { condition: "Dense Drizzle",       color: 2,  icon: "assets/icons/cloud-rain.svg" },
